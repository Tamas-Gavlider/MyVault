...
common_questions = {
    ...
    "suspend" : "You can temporarily suspend your account from the profile page. During suspension, all functions will be disabled until the account is reactivated with your private key.",
    "location" : "You have the option to enable location tracking. If activated, you’ll be able to view your last login location and current login location on Google Maps."
}
...
def ask(request):
    ...
    Questions will be saved so the admin can review them and add to the FAQ page.
    """
