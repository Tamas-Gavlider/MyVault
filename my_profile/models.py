...
class Profile(models.Model):
    ...
    sending_address = models.CharField(max_length=50, blank=True,
                                       null=True, unique=True)
    receiving_address = models.CharField(max_length=50, blank=True,
                                         null=True, unique=True)
    ...
    def __str__(self):
        return f'{self.user} - {self.sending_address} -/n'
